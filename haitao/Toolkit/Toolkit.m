...
UIButton * addButtonWithframeAndtextAndactionAndtargetAndtag(CGRect frame ,NSString * image,SEL sender,id delegate,int tag)
{
    ...
    UIImageView * img = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, btnNormal.frame.size.width, btnNormal.frame.size.height)];
    img.tag = tag+10000;
...
extern UIImage* getImgFromUrl(NSString * strFrom)
{
    ...
    UIImage * img = [[UIImage alloc]initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:strTo]]];
    return img;
}
